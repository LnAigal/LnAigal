...
## 🚀 Featured Project — ConsumerShield
...
| Feature | Tech Used |
|---|---|
| 🧠 AI Dark Pattern Detection | Google Gemini API · BART Large MNLI (Hugging Face) |
| ⛓️ Blockchain Logging | Solidity · Web3.py · Ethereum Sepolia via Remix IDE |
| 🖥️ Backend API | FastAPI · Python |
| 🌐 Frontend Extension | Chrome Extensions API · Vanilla JS · HTML/CSS |
| 📊 Dashboard | React JSX · Cyberpunk UI with Matrix Rain effects |
| 📋 Compliance | India's DPDP Act 2023 |
...
| Project | Description |
|---|---|
| 🔗 **Laksh Builds** | Central hub for all my projects |
| 📘 **NMAMIT Notes Hub** | 1st Year Notes Platform for students |
| 📗 **Laksh Notes 2.0** | 2nd Year AIML Notes & Resources |
| 🧪 **Laksh LabCode** | Lab Programs + Downloadable PDFs |

### 🛠️ Tools & Apps
| Project | Description |
|---|---|
| 📖 **Laksh Guides** | Coding & Tech References |
| ✅ **Task Master** | Full-featured Task Management App |
| 📂 **Laksh Drops** | Drag & Drop File Sharing |
| 🎵 **Laksh Music** | Web-based Music Player |
| 🌐 **Laksh Portfolio** | Personal Portfolio Website |
